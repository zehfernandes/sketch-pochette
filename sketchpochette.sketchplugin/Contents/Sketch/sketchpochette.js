...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/sketchpochette.js");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/8610e2caec022886ad58fc1e1a796776.html").path();

/***/ }),

/***/ "./src/sketchpochette.js":
/*!*******************************!*\
  !*** ./src/sketchpochette.js ***!
  \*******************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  var selection = context.selection; // Error: Select element!

  if (selection.length <= 0) {
    sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.message("You need select a element");
    return;
  }
  ...
  webContents.on("updateElements", function (attribute, num) {
    if (typeof parseInt(num) != "number") {
      return;
    }

    var updateAttribute = updateMethodList[attribute];
  ...
  webContents.on("loadSelectElements", function (s) {
    var object = [];
...
//# sourceMappingURL=sketchpochette.js.map